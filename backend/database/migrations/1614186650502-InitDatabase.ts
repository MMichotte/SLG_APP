...
export class InitDatabase1614186650502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "person" ("id" SERIAL NOT NULL, "civility" "person_civility_enum" NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "phone" character varying(255), "mobile" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id_address" integer, CONSTRAINT "UQ_d2d717efd90709ebd3cb26b936c" UNIQUE ("email"), CONSTRAINT "REL_b9c17cf5f6008b696fc821e11c" UNIQUE ("id_address"), CONSTRAINT "PK_5fdaf670315c4b7e70cce85daa3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "company" ("id" SERIAL NOT NULL, "type" "company_type_enum" NOT NULL, "name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "vat_num" character varying(255) NOT NULL, "phone_1" character varying(50), "phone_2" character varying(50), "mobile" character varying(50), "website" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id_person" integer, "id_address" integer, CONSTRAINT "UQ_b0fc567cf51b1cf717a9e8046a1" UNIQUE ("email"), CONSTRAINT "REL_f91edb8e73faf3ead32d4b90b7" UNIQUE ("id_address"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
